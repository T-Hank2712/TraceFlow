...
namespace TraceFlow.Api.Migrations
{
    ...
    [Migration("20260910145729_UpdateApiKeyGenerationSchema")]
    partial class UpdateApiKeyGenerationSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TraceFlow.Api.Domain.Entities.ApiKey", b =>
                {
                    ...
                    b.Property<string>("TraceApplicationId")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TraceFlow.Api.Domain.Entities.ApiKey", b =>
                {
                    b.HasOne("TraceFlow.Api.Domain.Entities.TraceApplication", "TraceApplication")
                        .WithMany("ApiKeys")
                        .HasForeignKey("TraceApplicationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("TraceApplication");
                });
