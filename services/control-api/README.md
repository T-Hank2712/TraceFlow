...
Control API làm việc chủ yếu với PostgreSQL cho dữ liệu nghiệp vụ và OpenSearch cho search/dashboard query. Service này không nhận log high-throughput trực tiếp; log ingestion thuộc trách nhiệm của Ingestion API.
