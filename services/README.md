...
- `ingestion-api/`: ASP.NET Core service nhận log từ application và publish vào Kafka.
- `log-processor/`: .NET Worker consume Kafka, xử lý batch và index vào OpenSearch.
